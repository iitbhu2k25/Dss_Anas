...
return (
  <div className="p-6 border rounded-lg bg-gradient-to-br from-white to-gray-50 shadow-lg">
    <h3 className="text-2xl font-bold text-gray-800 mb-4">Water Demand Calculation</h3>
    ...
    <div className="mb-6 flex flex-wrap gap-4">
      ...
      <label className="flex items-center space-x-2">
        <input
          type="checkbox"
          checked={floatingChecked}
          onChange={handleFloatingChange}
          className="form-checkbox h-5 w-5 text-blue-600 rounded"
        />
        <span className="text-sm font-medium text-gray-700">Floating</span>
      </label>
      <label className="flex items-center space-x-2">
        <input
          type="checkbox"
          checked={institutionalChecked}
      ...
      <label className="flex items-center space-x-2">
        <input
          type="checkbox"
          checked={firefightingChecked}
          onChange={handleFirefightingChange}
          className="form-checkbox h-5 w-5 text-blue-600 rounded"
        />
        <span className="text-sm font-medium text-gray-700">Firefighting</span>
      </label>
    </div>
    ...
    {domesticChecked && (
      <div className="mb-6 p-4 border rounded-lg bg-blue-50/50 shadow-sm">
        <h6 className="font-semibold text-lg text-blue-700 mb-3">Domestic Fields</h6>
        <div className="flex items-center">
          <label className="text-sm font-medium text-gray-700">Per Capita Consumption (LPCD):</label>
          <div className="flex items-center ml-2">
            <input
              type="number"
              value={perCapitaConsumption}
              onChange={handlePerCapitaChange}
              className="border border-gray-300 rounded-lg w-24 px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            />
            {/* Info icon with hover table */}
            <div className="relative inline-block ml-2 group z-50">
              <span className="flex items-center justify-center h-5 w-5 text-sm bg-red-500 text-white rounded-full cursor-help transition-transform hover:scale-110">i</span>
              <div className="absolute z-50 hidden group-hover:block w-[450px] text-xs rounded-lg shadow-xl bg-white border border-gray-200 -mt-56 left-1/2 transform -translate-x-1/2">
                <div className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-100">
                  <table className="table-fixed w-full border-collapse border border-gray-300 text-center text-xs">
                    <caption className="font-serif font-bold text-base text-gray-800 py-2">
                    ...
                    <thead className="bg-gradient-to-r from-blue-100 to-blue-200 sticky top-0 z-10">
                      <tr>
                        <th className="border border-gray-300 p-2 w-1/12">S. No.</th>
                        <th className="border border-gray-300 p-2 w-7/12 text-left">Classification of towns / cities</th>
                        <th className="border border-gray-300 p-2 w-4/12">Recommended Maximum Water Supply Levels (lpcd)</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="hover:bg-blue-50">
                        <td className="border border-gray-300 p-2">1.</td>
                        <td className="border border-gray-300 p-2 text-left">Towns provided with piped water supply but without sewerage system</td>
                        <td className="border border-gray-300 p-2">70</td>
                      </tr>
                      <tr className="bg-gray-50 hover:bg-blue-50">
                        <td className="border border-gray-300 p-2">2.</td>
                        <td className="border border-gray-300 p-2 text-left">Cities provided with piped water supply where sewerage system is existing/contemplated</td>
                        <td className="border border-gray-300 p-2">135</td>
                      </tr>
                      <tr className="hover:bg-blue-50">
                        <td className="border border-gray-300 p-2">3.</td>
                        <td className="border border-gray-300 p-2 text-left">Metropolitan and Mega cities provided with piped water supply where sewerage system is existing/contemplated</td>
    ...
    {floatingChecked && (
      <div className="mb-6 p-4 border rounded-lg bg-blue-50/50 shadow-sm">
        <h6 className="font-semibold text-lg text-blue-700 mb-3">Floating Fields</h6>
        ...
        <div className="mt-3">
          ...
          <select
            ...
            className="mt-2 border border-gray-300 rounded-lg w-full sm:w-1/2 px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          >
    ...
    {institutionalChecked && (
      <div className="mb-6 p-4 border rounded-lg bg-blue-50/50 shadow-sm">
        <h6 className="font-semibold text-lg text-blue-700 mb-3">Institutional Fields</h6>
        <div className="flex space-x-4 mb-4">
          <label className="inline-flex items-center">
            ...
            />
            <span className="ml-2 text-sm font-medium text-gray-700">Enter Individual Fields</span>
          </label>
          <label className="inline-flex items-center">
            <input
              type="radio"
            ...
            />
            <span className="ml-2 text-sm font-medium text-gray-700">Enter Total Institutional Demand</span>
          </label>
        </div>
        ...
        {institutionalInputMode === 'manual' && (
          <div className="grid grid-cols-2 gap-4">
            {[
              { id: 'hospitals_100_units', label: 'Hospitals with ≥ 100 Beds (Units)', key: 'hospitals100Units' },
              { id: 'beds_100', label: 'Beds in Hospitals with ≥ 100 Beds', key: 'beds100' },
              { id: 'hospitals_less_100', label: 'Hospitals with < 100 Beds (Units)', key: 'hospitalsLess100' },
              { id: 'beds_less_100', label: 'Beds in Hospitals with < 100 Beds', key: 'bedsLess100' },
              { id: 'hotels', label: 'Hotels (Units)', key: 'hotels' },
              { id: 'beds_hotels', label: 'Beds in Hotels', key: 'bedsHotels' },
              { id: 'hostels', label: 'Hostels (Units)', key: 'hostels' },
              { id: 'residents_hostels', label: 'Residents in Hostels', key: 'residentsHostels' },
              { id: 'nurses_home', label: 'Nurses Home (Units)', key: 'nursesHome' },
              { id: 'residents_nurses_home', label: 'Residents in Nurses Home', key: 'residentsNursesHome' },
              { id: 'boarding_schools', label: 'Boarding Schools (Units)', key: 'boardingSchools' },
              { id: 'students_boarding_schools', label: 'Students in Boarding Schools', key: 'studentsBoardingSchools' },
              { id: 'restaurants', label: 'Restaurants (Units)', key: 'restaurants' },
              { id: 'seats_restaurants', label: 'Seats in Restaurants', key: 'seatsRestaurants' },
              { id: 'airports_seaports', label: 'Airports/Seaports (Units)', key: 'airportsSeaports' },
              { id: 'population_load_airports', label: 'Population Load on Airports/Seaports', key: 'populationLoadAirports' },
              { id: 'junction_stations', label: 'Junction Stations (Units)', key: 'junctionStations' },
              { id: 'population_load_junction', label: 'Population Load on Junction Stations', key: 'populationLoadJunction' },
              { id: 'terminal_stations', label: 'Terminal Stations (Units)', key: 'terminalStations' },
              { id: 'population_load_terminal', label: 'Population Load on Terminal Stations', key: 'populationLoadTerminal' },
              { id: 'intermediate_bathing', label: 'Intermediate Bathing (Units)', key: 'intermediateBathing' },
              { id: 'population_load_bathing', label: 'Population Load on Intermediate Bathing', key: 'populationLoadBathing' },
              { id: 'intermediate_no_bathing', label: 'Intermediate No Bathing (Units)', key: 'intermediateNoBathing' },
              { id: 'population_load_no_bathing', label: 'Population Load on Intermediate No Bathing', key: 'populationLoadNoBathing' },
              { id: 'day_schools', label: 'Day Schools (Units)', key: 'daySchools' },
              { id: 'students_day_schools', label: 'Students in Day Schools', key: 'studentsDaySchools' },
              { id: 'offices', label: 'Offices (Units)', key: 'offices' },
              { id: 'employees_offices', label: 'Employees in Offices', key: 'employeesOffices' },
              { id: 'factories', label: 'Factories (Units)', key: 'factorieswashrooms' },
              { id: 'employees_factories', label: 'Employees in Factories (with Washrooms)', key: 'employeesFactories' },
              { id: 'factories_no_washrooms', label: 'Factories without Washrooms (Units)', key: 'factoriesnoWashrooms' },
              { id: 'employees_factories_no_washrooms', label: 'Employees in Factories (No Washrooms)', key: 'employeesFactoriesNoWashrooms' },
              { id: 'cinemas', label: 'Cinemas (Units)', key: 'cinemas' },
              { id: 'seats_cinemas', label: 'Seats in Cinemas', key: 'seatsCinemas' },
            ].map(({ id, label, key }) => (
              <div key={id}>
                ...
                <input
                  type="number"
                  id={id}
                  value={institutionalFields[key]}
                  onChange={(e) => handleInstitutionalFieldChange(key, e.target.value)}
                  className="mt-2 block w-full sm:w-1/2 border border-gray-300 rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                  placeholder="Enter number"
                />
              </div>
    ...
    {firefightingChecked && (
      <div className="mb-6 p-4 border rounded-lg bg-blue-50/50 shadow-sm">
        <h6 className="font-semibold text-lg text-blue-700 mb-3">Firefighting Fields</h6>
        <div className="flex flex-col gap-2">
          {[
            { key: 'kuchling', label: 'Kuchling' },
            { key: 'freeman', label: 'Freeman' },
            { key: 'buston', label: 'Buston' },
            { key: 'american_insurance', label: 'American Insurance' },
            { key: 'ministry_urban', label: 'Ministry Urban' },
          ].map(({ key, label }) => (
            <label key={key} className="flex items-center space-x-2">
              <input
                type="checkbox"
                checked={firefightingMethods[key]}
                onChange={(e) => handleFirefightingMethodChange(key, e.target.checked)}
                className="form-checkbox h-5 w-5 text-blue-600 rounded"
              />
        ...
        {firefightingDemand && (
          <div className="mt-4">
            <h6 className="font-semibold text-lg text-blue-700 mb-2">Firefighting Demand Output</h6>
                ...
                <thead className="bg-gradient-to-r from-blue-100 to-blue-200 sticky top-0 z-10">
                  <tr>
                    ...
                    {Object.keys(firefightingDemand).map((method) => (
                      <th key={method} className="border-b border-gray-300 px-6 py-3 text-left text-sm font-semibold text-gray-800">{method}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {Object.keys(forecastData).sort().map((year, index) => (
                    <tr key={year} className={`hover:bg-blue-50 transition-colors ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>
                      ...
                      {Object.keys(firefightingDemand).map((method) => (
                        <td key={method} className="border-b border-gray-200 px-6 py-3 text-gray-700">
            ...
            <p className="mt-3 text-sm font-semibold text-gray-700">Select one method for final output:</p>
    ...
    <div className="flex items-center space-x-4">
      ...
      {isCalculating && (
        <div className="inline-flex items-center">
          ...
          <span className="ml-2 text-sm text-gray-700">Calculating...</span>
        </div>
      )}
    </div>
    ...
    {(domesticDemand || floatingDemand || institutionalDemand || firefightingDemand) && forecastData && (
      <div className="mt-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Water Demand Results</h2>
        <div className="max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-100">
          <table className="table-auto w-full min-w-[600px] bg-white border border-gray-300 rounded-lg shadow-md">
            <thead className="bg-gradient-to-r from-blue-100 to-blue-200 sticky top-0 z-10">
              <tr>
