              ...
              {([
                ...
                <div key={id}>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInstitutionalFieldChange(key as keyof InstitutionalFields, e.target.value)}
                    className="mt-2 block w-full sm:w-1/2 border border-gray-300 rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    placeholder="Enter number"
                  />
                </div>
            ...
            {([
              ...
              <label key={key} className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleFirefightingMethodChange(key as keyof FirefightingMethods, e.target.checked)}
                  className="form-checkbox h-5 w-5 text-blue-600 rounded"
                />
