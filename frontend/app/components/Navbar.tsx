...
const Navbar = (): JSX.Element => {
  ...
  return (
    <nav
      ref={navRef}
      className={`${
        isSticky ? 'bg-orange-300 shadow-md fixed top-0 left-0 w-full z-50' : 'bg-opacity-10 bg-[#081F5C]'
          ...
          <ul className="flex flex-col lg:flex-row lg:justify-center space-y-2 lg:space-y-0">
            ...
            <li className="relative group">
              ...
              >
                ...
                <li className="relative group/submenu py-1">
                  <div
                    className="w-full text-left px-4 py-1 text-blue-600 font-semibold hover:bg-blue-50 hover:bg-opacity-10 rounded-md transition duration-200 flex justify-between items-center cursor-pointer"
                    onClick={(e) => toggleSubmenu(e, 'gwPotential')}
                  >
                    Groundwater Potential Assessment
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.gwPotential ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                      openDropdowns.gwPotential ? 'block' : 'hidden'
                    } lg:hidden lg:group-hover/submenu:block lg:absolute lg:left-full lg:top-0 lg:bg-white lg:bg-opacity-95 lg:border lg:border-gray-200 lg:border-opacity-10 lg:rounded-lg lg:shadow-lg lg:min-w-[300px] lg:p-3 lg:ml-0 lg:z-50 ml-4`}
                  >
                    <li>
                      <Link
                        href="#"
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Resource Estimation
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.gwResource ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                      openDropdowns.gwResource ? 'block' : 'hidden'
                    } lg:hidden lg:group-hover/submenu:block lg:absolute lg:left-full lg:top-0 lg:bg-white lg:bg-opacity-95 lg:border lg:border-gray-200 lg:border-opacity-10 lg:rounded-lg lg:shadow-lg lg:min-w-[320px] lg:p-3 lg:ml-0 lg:z-50 ml-4`}
                  >
                    <li>
                      <Link
                        href="#"
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Managed Aquifer Recharge
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.gwAquifer ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    River Aquifer Interaction
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.gwRiver ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
              ...
              >
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Resource Estimation
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.rwEstimation ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Flood Forecasting and Management
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.rwFlood ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Water Bodies Management
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.rwWaterBodies ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Waste Water Treatment
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.rwWasteWater ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                  ...
                  >
                    ...
                    <li>
                      <Link
                        href="/dss/riverwatermangement/wastewatertreatment/stp"
                        className="block px-4 py-2 text-blue-600 font-semibold hover:bg-blue-50 hover:bg-opacity-10 rounded-md transition duration-200"
                      >
              ...
              >
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Demand and Forecasting
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.wrmDemand ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Resource Allocation
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.wrmAllocation ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                      openDropdowns.wrmAllocation ? 'block' : 'hidden'
                    } lg:hidden lg:group-hover/submenu:block lg:absolute lg:left-full lg:top-0 lg:bg-white lg:bg-opacity-95 lg:border lg:border-gray-200 lg:border-opacity-10 lg:rounded-lg lg:shadow-lg lg:min-w-[220px] lg:p-3 lg:ml-0 lg:z-50 ml-4`}
                  >
                    <li>
                      <Link
                        href="#"
              ...
              >
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Resource Management
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.shsdResource ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                      openDropdowns.shsdResource ? 'block' : 'hidden'
                    } lg:hidden lg:group-hover/submenu:block lg:absolute lg:left-full lg:top-0 lg:bg-white lg:bg-opacity-95 lg:border lg:border-gray-200 lg:border-opacity-10 lg:rounded-lg lg:shadow-lg lg:min-w-[360px] lg:p-3 lg:ml-0 lg:z-50 ml-4`}
                  >
                    <li>
                      <Link
                        href="#"
                ...
                <li className="relative group/submenu py-1">
                  ...
                  >
                    Impact Assessment
                    <ChevronRight
                      className={`w-4 h-4 ${openDropdowns.shsdImpact ? 'rotate-90' : ''} lg:group-hover/submenu:rotate-90 transition-transform duration-200`}
                    />
                  </div>
                  <ul
                    className={`${
                      openDropdowns.shsdImpact ? 'block' : 'hidden'
                    } lg:hidden lg:group-hover/submenu:block lg:absolute lg:left-full lg:top-0 lg:bg-white lg:bg-opacity-95 lg:border lg:border-gray-200 lg:border-opacity-10 lg:rounded-lg lg:shadow-lg lg:min-w-[250px] lg:p-3 lg:ml-0 lg:z-50 ml-4`}
                  >
                    <li>
                      <Link
                        href="#"
            ...
            <li className="relative group">
              ...
              <ul
                ...
                } lg:hidden lg:group-hover:block absolute left-0 top-full bg-white bg-opacity-95 border border-gray-200 border-opacity-10 rounded-lg shadow-lg min-w-[240px] p-3 z-50`}
              >
                <li>
                  <Link
                    href="#"
                    className="block px-4 py-1 text-blue-600 font-semibold hover:bg-blue-50 hover:bg-opacity-10 rounded-md transition duration-200"
                  >
            ...
            <li className="relative group">
              ...
              <ul
                className={`${
                  openDropdowns.account ? 'block' : 'hidden'
                } lg:hidden lg:group-hover:block absolute left-0 top-full bg-white bg-opacity-95 border border-gray-200 border-opacity-10 rounded-lg shadow-lg min-w-[150px] p-3 z-50`}
              >
                <li>
                  <Link
